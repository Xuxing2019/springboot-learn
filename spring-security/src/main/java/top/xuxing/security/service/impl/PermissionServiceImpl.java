...
public class PermissionServiceImpl implements PermissionService {
    ...
    static {
        ...
        Permission permission_delete = new Permission(1L, "删除", "删除权限");
        Permission permission_update = new Permission(1L, "修改", "修改权限");
        Permission permission_query = new Permission(1L, "查询", "查询权限");
