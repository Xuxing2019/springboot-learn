package top.xuxing.websocket.utils;
...
public class WebSocketUtil {
    ...
    public static void sendOneMessageToChatRoom(String sessionToken, String type, SendToOneRequest sendToOneRequest) {
        // 前端建立一个聊天室，在这个聊天室中发送的消息都带有该聊天室的标识，所有在该聊天室发出的信息都会在前端页面显示
        send(sessionToken, type,sendToOneRequest);
    }
}
